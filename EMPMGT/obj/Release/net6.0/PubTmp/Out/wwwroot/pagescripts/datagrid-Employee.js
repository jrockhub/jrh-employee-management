$(() => {
    if ($('#Jrockhub_Employee').length !== 0) {
        var table = $('#Jrockhub_Employee').DataTable({
        ...
        table.columns().every(function (index) {
            $('#Jrockhub_Employee thead tr:last th:eq(' + index + ') input')
                .on('keyup',
                    function (e) {
                        if (e.keyCode === 13) {
        ...
        $(document)
            ...
            .on('click', '.btnEdit', function () {
                ...
                window.location.href = `/EmployeeAdd/Edit/${id}`;
        ...
        $(document)
            ...
            .on('click', '.btnDelete', function () {
                ...
                Swal.fire({
                    ...
                    t.value
                    if (t.value == true) {
                        fetch(`/EmployeeAdd/Delete/${id}`)
                            .then((response) => {
                                Swal.fire({
                                    type: "success",
                                    title: "Deleted!",
                                    text: "Your record has been deleted.",
                                    confirmButtonEmployee: "btn btn-success"
                                }).then(function (t) {
    ...
    $('#Employeetab ul').attr("style", "display:block");
    $('#Employeetabgrid').addClass("active");
